...
def norm_data(args):
    ...
    if args.dataset == 'M-AILABS':
        ...
        supported_readers = [e for e in os.listdir(path) if e not in ['.DS_Store', 'info.txt', '._info.txt']]
        ...
        supported_books = [e for e in os.listdir(path) if e not in ['.DS_Store', 'info.txt', '._info.txt']]
